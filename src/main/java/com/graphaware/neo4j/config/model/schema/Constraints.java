...
public record Constraints(List<NodeConstraint> nodes, List<RelationshipConstraint> relationships) {

    public Constraints {
        nodes = List.copyOf(Optional.ofNullable(nodes).orElse(List.of()));
